                ...
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <div class="collapse navbar-collapse" id="navbarCollapse">
                        ...
                        <ul class="navbar-nav mr-2">
                            <li class="nav-item">
                                <a class="nav-link" href="#"><img style="filter: invert(100%);" src="images/icons8-favorite-folder-50.png" width="30"></a>
                            </li>
                        </ul>
                    </div>
                </nav>
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12 mt-5">
                        <div class="page-wrapper">
                            <div class="blog-top clearfix d-flex">
                                ...
                                <h4 class="pull-left mr-4">Favourites <img  src="images/icons8-favorite-folder-50.png" width="20"></h4>
                                <label for="">сортировка по дате &nbsp</label>
...
<!-- <?var_dump($favourite_posts)?> -->
    ...
    <script src="handlers/haandler_favourites.js"></script>
